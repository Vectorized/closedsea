 ...
 */
abstract contract ExampleERC721AUpgradeable is ERC721AUpgradeable, OperatorFilterer, OwnableUpgradeable {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public payable override onlyAllowedOperator(from, true) {
