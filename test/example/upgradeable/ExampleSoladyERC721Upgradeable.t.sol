...
import {ExampleSoladyERC721Upgradeable} from
    "../../../src/example/upgradeable/ExampleSoladyERC721Upgradeable.sol";
import {BaseRegistryTest} from "../../BaseRegistryTest.sol";
import {Initializable} from "openzeppelin-contracts-upgradeable/proxy/utils/Initializable.sol";

contract TestableExampleSoladyERC721 is ExampleSoladyERC721Upgradeable {
...
contract ExampleSoladyERC721UpgradeableTest is BaseRegistryTest, Initializable {
    TestableExampleSoladyERC721 example;
    ...
    function setUp() public override {
        ...
        example = new TestableExampleSoladyERC721();
        example.initialize();
    }

    function testUpgradeable() public {
        TestableExampleSoladyERC721 example2 = new TestableExampleSoladyERC721();
